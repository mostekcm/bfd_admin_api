...
var _move_to_mongo = require('./api/orders/routes/move_to_mongo');

var _move_to_mongo2 = _interopRequireDefault(_move_to_mongo);
...
var _post_sync_wholesale_customer_sheet = require('./api/crm/routes/post_sync_wholesale_customer_sheet');

var _post_sync_wholesale_customer_sheet2 = _interopRequireDefault(_post_sync_wholesale_customer_sheet);
...
var register = function register(server, options, next) {
  ...
  server.route((0, _move_to_mongo2.default)(server));
  ...
  server.route((0, _post_sync_wholesale_customer_sheet2.default)(server));
  next();
};

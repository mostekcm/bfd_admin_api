      ...
      if (this.orders[orderId]) {
        ...
        return getRows({
          ...
          if (newOrderAttributes.paidDate !== undefined) {
            rows[0].paiddate = _this2.orders[orderId].paidDate = newOrderAttributes.paidDate;
          }

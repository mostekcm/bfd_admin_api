...
exports.default = function () {
  return {
    ...
    config: {
      ...
      validate: {
        params: {
          month: _joi2.default.number().min(0).max(12).required(),
    ...
    handler: function handler(req, reply) {
      ...
      labelService.getAll().then(function (labelUse) {
        var getPromise = req.params.month === 0 ? orderService.getNextMonthOrders() : orderService.getMonthOrders(req.params.month, year);
        return getPromise.then(function (orders) {

...
var displayItem = _joi2.default.object().keys({
...
var store = _joi2.default.object().keys({
  name: _joi2.default.string().max(500).required(),
...
exports.default = _joi2.default.object().keys({
  ...
  displayItems: _joi2.default.array().items(displayItem).required(),
  notes: _joi2.default.string().max(10000).allow(''),

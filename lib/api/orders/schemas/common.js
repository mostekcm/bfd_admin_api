...
exports.commission = exports.payment = exports.store = exports.displayItem = exports.lineItem = undefined;
...
var displayItem = exports.displayItem = _joi2.default.object().keys({
  ...
  offsetMerch: _joi2.default.array().items(offsetMerch).required(),
...
var store = exports.store = _joi2.default.object().keys({
  ...
  billingAddress: _joi2.default.string().max(500).allow('')
});

var payment = exports.payment = _joi2.default.object().keys({
  date: _joi2.default.number().min(1).required(),
  amount: _joi2.default.number().min(0.01).max(1000000).required()
});

var commission = exports.commission = _joi2.default.object().keys({
  payee: _joi2.default.string().min(1).required(),
  paidDate: _joi2.default.number().min(1).required(),
  paidAmount: _joi2.default.number().min(0.01).max(1000000).required(),
  multiplier: _joi2.default.number().min(0.01).max(1.0)
});